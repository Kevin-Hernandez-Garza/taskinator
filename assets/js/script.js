...
var taskFormHandler = function (event) {
    // prevents the browser to refresh when we press the "add task" button
    ...
    // check if inputs are empty (validate it)
...
var createTaskEl = function (taskDataObj) {
    var listItemEl = document.createElement("li"); // create new list item 
    listItemEl.className = "task-item"; // giving new list item a class name 
...
var createTaskActions = function (taskId) {
    ...
    var actionContainerEl = document.createElement("div"); // creating div element 
